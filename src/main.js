...
const ffmpegEnvLambda = {
  "LD_PRELOAD":`${rootPath}/libX11.so.6:${rootPath}/libXau.so.6:${rootPath}/libXdmcp.so.6:${rootPath}/libXext.so.6:${rootPath}/libXv.so.1:${rootPath}/libbz2.so.1.0:${rootPath}/libssl.so.1.0.0:${rootPath}/libcrypto.so.1.0.0`
};
